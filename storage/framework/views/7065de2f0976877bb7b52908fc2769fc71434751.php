      ...
      <div class="container">
        <div class="row justify-content-center align-items-center py-lg-5 py-3">
          <div class="col">
                      ...
                      <div class="avatar-edit position-static">
                        ...
                        <label for="imageUpload" class="position-relative">
                          ...
                          <div class="avatar-preview  avatar-preview-sm mx-auto">
                            <?php if($logo != null): ?>
                              <img class="candidate_thumb rounded-50" src="<?php echo e(asset('public/storage/' . $logo)); ?>"
                                alt="" id="imagePreview">
                            <?php else: ?>
                              <img class="candidate_thumb rounded-50"
                                src="<?php echo e(asset('adminpanel/images/avatar/dummy.png')); ?>" alt="" id="imagePreview">
                            <?php endif; ?>
                          </div>
                        </label>
                      </div>
            ...
            <!-- fieldsets -->
            <form id="msform" method="POST" action="<?php echo e(route('company.store')); ?>" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
              <fieldset class="mb-4">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <label for="name" class="form-label fs-14 text-theme-primary fw-bold">First
                      Name*</label>
                    <input type="text" class="form-control h-50px" name="name" value="<?php echo e(auth()->user()->name); ?>"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="name" class="form-label fs-14 text-theme-primary fw-bold">Last
                      Name*</label>
                    <input type="text" class="form-control h-50px" name="lname" value="<?php echo e(auth()->user()->lname); ?>"
                      required>
                  </div>
                </div>
              </fieldset>
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="single-field full-width phone-input-flag d-flex ">
                      <input type="tel" class="mobile-number form-control h-50px" style="color: transparent;"
                        name="country_code" value="<?php echo e($country_code); ?>" required>
                      <input type="tel" class="mobile-number-full form-control h-50px"
                        placeholder="Please Enter Phone Number" name="phone" maxlength="11" value="<?php echo e($phone); ?>"
                        required>
                    </div>
                  </div>
                  <div class="col-lg-3">
                    ...
                    <select data-placeholder="Please select category" name="category[]" id="role"
                      ...
                      <?php $__currentLoopData = $cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($ca->id); ?>"
                          <?php if($comp != null): ?> <?php $__currentLoopData = $comp->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($row->id == $ca->id): ?>
                                                            Selected <?php endif; ?>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      <?php endif; ?>><?php echo e($ca->name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                  <div class="col-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/company/detail.blade.php ENDPATH**/ ?>
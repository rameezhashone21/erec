    ...
    <section class="pt-5">
        <div class="container">
            <div class="row justify-content-center align-items-center py-lg-5 py-3">
                ...
                <form id="msform" method="POST" action="<?php echo e(route('store.candidateEducation')); ?>"
                        ...
                        <div class="row row-cols-1">
                            <div class="col d-flex justify-content-between align-items-center">
                                ...
                                <a href="javascript:void(0)" id="addbtn" role="button" class="duplicate"><img
                                        src="<?php echo e(asset('images/plus-circle.svg')); ?>" alt="plus-circle" class="img-fluid"></a>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5 text-center">
                            ...
                            <br />
                            <br />
                            <a href="<?php echo e(route('candidates.details.profile')); ?>" class="fs-6 fw-normal">
                                << Go Back</a>
                        </div>
                    </div>
                </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/candidates/education.blade.php ENDPATH**/ ?>
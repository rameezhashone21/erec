<header class="py-3 py-lg-0 header-dashboard" id="headerDashboard">
    ...
    <div class="container">
        <div class="d-flex d-lg-none align-items-center">
            <div>
                <a class="navbar-brand" href="<?php echo e(route('index')); ?>"><img src="<?php echo e(asset('/dashboard/images/logo.png')); ?>"
            ...
            <div class="ml-auto d-flex w-100 justify-content-end">
                <div class="dropdown">
                        ...
                        <?php if(isset(auth()->user()->recruiter)): ?>
                            ...
                            <?php if(auth()->user()->recruiter->avatar != null): ?>
                                <img class="profile_thumb me-2 rounded-50"
                                    src="<?php echo e(asset('storage/' . auth()->user()->recruiter->avatar)); ?>"
                                    alt="">
                            <?php else: ?>
                                <img class="profile_thumb me-2 rounded-50"
                    ...
                    <ul class="dropdown-menu user-setting" aria-labelledby="messageDropdown">
                        ...
                        <li class="p-2 mx-3">
                            <a class="dropdown-item fs-12 p-0 d-flex justify-content-between"
                                href="<?php echo e(route('recruiter.profile')); ?>">
                                <span>
                                    My Profile
                                </span>
                                <span>
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-md-10 row align-items-center justify-content-end">
                        ...
                        <div class="d-flex align-items-center col-xxl-6 col-lg-7 mt-3 mt-lg-0" style="gap: 1.3rem">
                            <a href="<?php echo e(route('employer.list')); ?>"
                                ...
                                <ul class="dropdown-menu user-setting" aria-labelledby="messageDropdown">
                                    <?php if(Route::is('recruiter.map')): ?>
                                        <li class="p-2 mx-3">
                                            <a class="dropdown-item p-0 d-flex justify-content-between"
                                                href="<?php echo e(route('home')); ?>" style="font-size: 14px;">
                                                <span>
                                                    Profile
                                                </span>
                                                <span>
                                    ...
                                    <li class="p-2 mx-3">
                                        <a class="dropdown-item d-flex justify-content-between p-0"
                                            href="<?php echo e(route('dashboard')); ?>" style="font-size: 14px;">
                                            <span>
                                                Dashboard
                                            </span>
                                            <span>
                                    ...
                                    <li class="p-2 mx-3">
                                        <a class="dropdown-item d-flex justify-content-between p-0"
                                            href="<?php echo e(route('recruiter.jobs')); ?>" style="font-size: 14px;">
                                            <span>
                                                My Job Posts
                                            </span>
                                            <span>
                                    ...
                                    <li class="p-2 mx-3">
                                        <a class="dropdown-item p-0 d-flex justify-content-between"
                                            href="<?php echo e(route('recruiter.profile')); ?>" style="font-size: 14px;">
                                            <span>
                                                My Profile
                                            </span>
                                            <span>
                                    ...
                                    <li class="p-2 mx-3">
                                        <a class="dropdown-item p-0 d-flex justify-content-between"
                                            href="<?php echo e(route('recruiter.companyIndex')); ?>" style="font-size: 14px;">
                                            <span>
                                                Employers
                                            </span>
                                            <span>
                                    ...
                                    <li class="p-2 mx-3">
                                        <a class="dropdown-item p-0 d-flex justify-content-between"
                                            href="<?php echo e(route('recruiter.candidateIndex')); ?>" style="font-size: 14px;">
                                            <span>
                                                Candidates
                                            </span>
                                            <span>
                                    ...
                                    <li class="p-2 mx-3">
                                        <a class="dropdown-item p-0 d-flex justify-content-between"
                                            href="<?php echo e(route('recruiter.map')); ?>" style="font-size: 14px;">
                                            <span>
                                                Map View
                                            </span>
                                            <span>
                            ...
                            <div class="dropdown d-none d-lg-block">
                                ...
                                <ul class="dropdown-menu user-setting notifications-dropdown" aria-labelledby="notificationsDropdown">
                                    <li class='d-flex align-items-center justify-content-between p-2 mx-3'>
                                        ...
                                        <div>
                                            <a href=<?php echo e(route("recruiter.markNotificationsRead")); ?> class='fs-14 text_primary onhover_text-decoration'> Mark as all read </a>
                                        </div> 
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <a class="dropdown-item fs-12 d-flex align-items-center" style="background-color: #f5f5f5;"
                                            href="<?php echo e(route('recruiter.job.applicantsById', ['id' => $notification->job_id , 'notification_id' => $notification->id])); ?>">
                                        <span>
                                        ...
                                        <?php elseif($notification->status == "Recruiter Connection Request Accepted" || $notification->status == "Recruiter Connection Request Rejected" || 
                                    ...
                                    <li class='text-center'>
                                        <a href="<?php echo e(route('recruiter.allNotifications')); ?>" class='fs-14 text_primary onhover_text-decoration'> See all notifications </a>
                                    </li>
                    ...
                    <div class="col-12">
                        <ul class="navbar-nav justify-content-center">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('about')); ?>"
                                    ...
                                    Us</a> </li>
                            <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('employer.list')); ?>"
                                    <?php if(Route::is('employer.list')): ?> class="nav-link active" <?php else: ?> class="nav-link" <?php endif; ?>>Employers</a>
                            </li>
...
<?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/recruterpanel/includes/header.blade.php ENDPATH**/ ?>
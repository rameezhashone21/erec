 <?php $__env->startSection('content'); ?>
    <main>
        <section>
            <form action="<?php echo e(route('employer.list')); ?>">
                <div class="container pt-5 mt-4">
                    <h1 class="fs-48 text-center fw-bold text-uppercase my-md-5 pb-4 pb-md-0">
                        Employers
                    </h1>
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-md-4">
                            <?php if(Auth::check()): ?>
                                ...
                                <?php endif; ?>
                            <?php endif; ?>
                            <div class="row row-cols-1 form__search__box search-area mb-3 py-4 px-3 d-block" id="search_comp">
                                
                                <div class="col ">
                                    <div class="position-relative">
                                        <input type="text" name="search_comp" id="search-title" autocomplete="off"
                                            class="w-100 fs-14 bg-theme-secondary text-dark h-50px mb-3"
                                             placeholder="Enter employer name here"
                                            value="<?php echo e($search_word); ?>">
                                ...
                                <div class="search-area mb-3 py-3 px-3 mb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a data-bs-toggle="collapse" href="#Designation" role="button"
                                            ...
                                            aria-controls="Designation" id="collapseButtonOne" 
                                            class="">
                                                    ...
                                                    <li class="d-flex justify-content-between align-items-center py-2">
                                                        <div class="form-check">
                                                            <input class="form-check-input rounded-pill" type="checkbox"
                                                                value="<?php echo e($row->id); ?>" name="search_skills[]"
                                                                id="fjkl<?php echo e($row->id); ?>"
                                                                <?php $__currentLoopData = $value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($row->id == $col): ?>
                                                                checked=checked
                                                            <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> />
                                                            <label class="form-check-label" for="fjkl<?php echo e($row->id); ?>">
                                                                <?php echo e($row->name); ?>
                                ...
                                <div class="mt-2 text-end">
                                    <a href="javascript:void(0)" class="fs-14" id="employerReset">
                        ...
                        <div class="col-lg-9 col-md-8">
                                ...
                                <div class="col-lg-4">
                                    <h3 class="view_profile_description fs-16 mb-0">Showing
                                        ...
                                        <?php if(count($comp) > 0): ?>
                                            1-
                                        <?php endif; ?>
                                        <?php echo e(count($comp)); ?> Of <?php echo e($comp->total()); ?> Employers
                                    </h3>
                                </div>
                                <div class="col-lg-7">
                                    <form action="<?php echo e(route('employer.list')); ?>" method="get">
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <div>
                                                <select id="role" onchange="this.form.submit()" name="per_page"
                                                    ...
                                                    <option value="10"
                                                        <?php if($pg == 10): ?> selected <?php endif; ?>>10
                                                        Per Page</option>
                                                    <option value="25"
                                                        <?php if($pg == 25): ?> selected <?php endif; ?>>25
                                                        Per Page</option>
                                                    <option value="50"
                                                        <?php if($pg == 50): ?> selected <?php endif; ?>>50
                                                        Per Page</option>
                                                    <option value="100"
                                            ...
                                            <div class="new-recruter-box">
                                                <?php if($row->user->banner != null): ?>
                                                    <img src="<?php echo e(asset('storage/' . $row->user->banner)); ?>"
                                                        alt="<?php echo e($row->name); ?>" class="user_banner img-fluid">
                                                <?php else: ?>
                                                    <img src="<?php echo e(asset('dashboard/images/Company.png')); ?>"
                                                        alt="<?php echo e($row->name); ?>" class="user_banner img-fluid">
                                                <?php endif; ?>
                                                <div class="text-center px-3 pb-4">
                                                    ...
                                                    <?php if(isset($row->location)): ?>
                                                        <p
                                                            ...
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="10.858"
                                                                    height="14.605" viewBox="0 0 10.858 14.605">
                                                                    <g id="location-pin"
                                                                        transform="translate(-5.627 -1.238)">
                                                                        <path id="Path_3244" data-name="Path 3244"
                                                                            d="M15.352,8.971a2,2,0,1,0,2,2A2,2,0,0,0,15.352,8.971Zm0,3a1,1,0,1,1,1-1,1,1,0,0,1-1,1Z"
                                                                            transform="translate(-4.297 -4.3)"
                                                                            fill="#c4c4c4" />
                                                    ...
                                                    <?php endif; ?>
                                                    <p class="job_type mb-3"><?php echo e($row->type); ?></p>
                            ...
                            <div class="d-flex justify-content-center pt-5">
                                <?php echo e($comp->appends(request()->except(['page', '_token']))->links()); ?>
...
<?php $__env->startSection('bottom_script'); ?>
    ...
    <script>
        ...
        const searchLogic = function() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(route('searchCompanySmart')); ?>",
                data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/company/companyList.blade.php ENDPATH**/ ?>
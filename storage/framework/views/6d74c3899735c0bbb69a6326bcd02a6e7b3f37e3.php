...
<div class="col-xl-9 col-lg-8">
  ...
  <div class="dashboard_content bg-white rounded_10 p-md-4 p-2">
    ...
    <?php $__currentLoopData = $docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="d-flex justify-content-between border-bottom py-3">
      <div class="d-flex align-items-center" style="gap: 0 8px;">
        <a class="d-flex align-items-center" style="gap: 0 15px;" href="<?php echo e(asset('candidateDoc/doc/' . $item->document)); ?>" target="_blank">
          <span>
            
            <?php if(pathinfo($item->document, PATHINFO_EXTENSION) == 'pdf'): ?>
            ...
            <?php elseif(pathinfo($item->document, PATHINFO_EXTENSION) == 'docx'): ?>
      ...
      <div class="d-flex align-items-center">
        <span class="me-lg-5 me-3">
          <a href="<?php echo e(asset('candidateDoc/doc/' . $item->document)); ?>" download="">
        ...
        <span>
          ...
          <a class="d-inline-block  text_grey_999" role="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" onclick="callModal(<?php echo e($item->id); ?>)">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo e(route('candidates.cv.store')); ?>" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
...
<script>
  function callModal(id) {
    // console.log(id);
    var href = '<?php echo e(route("candidates.cv.destroy", ":id ")); ?>';
    ...
    Swal.fire({
        ...
        confirmButtonText: "<a class='text-white' id='delete-edu' href='<?php echo e(route('candidates.cv.destroy', '')); ?>/" +
          id +
          "'>Yes</a>",
        cancelButtonText: 'No',
      })
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('candidatepanel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/candidatepanel/pages/cvList.blade.php ENDPATH**/ ?>
                              ...
                              <tr>
                                <td align="center">
                                  <font class="btn btn_viewall" STYLE="cursor: pointer"
                                    <?php if($row->qst_id != '0'): ?> onClick="openWindow1('<?php echo e($key); ?>','<?php echo e($row->post->post); ?>')" <?php endif; ?>
                                    size="-1">
                                    Start
                                  </font>
                                </td>
...
<?php echo $__env->make('candidatepanel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/candidatepanel/pages/jobApplications/index.blade.php ENDPATH**/ ?>
          ...
          <tbody>
            <?php if(count($post->jobAppRecComp) > 0): ?>
              ...
              <?php if($row->status != 0 && $row->status != 1 ): ?>
                <?php if($row->result != null && $row->qst_id != 0): ?>
                  <tr>
...
<?php echo $__env->make('recruterpanel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rameez Ali\Documents\erec1\resources\views/recruterpanel/pages/jobs/exam_results.blade.php ENDPATH**/ ?>
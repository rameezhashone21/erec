        ...
        <div class="row justify-content-center">
            <div class="col-xl-9 col-lg-8">
                ...
                <div class="dashboard_content bg-white rounded_10 p-md-4 p-2">
                    ...
                    <form action="<?php echo e(route('candidates.parseResume')); ?>" method="POST" enctype="multipart/form-data" id="res-perser">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-6" id="uploadWrapper">
                                <label class="upload__wrapper d-block" for="cvFile">
                                    <div class="mb-4">
                                        <img src="<?php echo e(asset('/images/Upload-cv-builder.png')); ?>" alt="" class="img-fluid">
                                    </div>
                                    <p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('candidatepanel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/candidatepanel/pages/resumeParser/cvParser.blade.php ENDPATH**/ ?>
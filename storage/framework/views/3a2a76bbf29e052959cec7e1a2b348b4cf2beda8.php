                    ...
                    <div class="col">
                      <div class="new-recruter-box">
                        <?php if($row->user->banner != null): ?>
                          <img src="<?php echo e(asset('public/storage/' . $row->user->banner)); ?>" alt="profile-img"
                        ...
                        <div class="text-center px-3 pb-4">
                          <?php if($row->avatar != null): ?>
                            <img src="<?php echo e(asset('public/storage/' . $row->avatar)); ?>" alt="profile-img" class="user_logo">
                          <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erec\resources\views/recruiter/list.blade.php ENDPATH**/ ?>
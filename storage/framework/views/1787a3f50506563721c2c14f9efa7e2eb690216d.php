                            ...
                            <div class="col">
                                <div class="double_range_slider_wrapper position-relative">
                                    ...
                                    <div>
                                        ...
                                        <input name="s1" type="range" min="0" max="100" value="30"
                                            id="slider-1" oninput="slideOne()">
                                        <input name="s2" type="range" min="0" max="100" value="70"
...
<?php $__env->startSection('bottom_script'); ?>
    ...
    <script>
        ...
        console.log("k")
         ...
         var sliderOne = document.getElementById("slider-1").value;
        var sliderTwo = document.getElementById("slider-2").value;
    ...
    <script>
        ...
        $('#smart-search').on('submit', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('smartSearch.candidate')); ?>",
                data: userFormData,
                dataType: "json",
                encode: true,
            }).done(function(data) {
                ...
                if (data.length == 0) {
                    ...
                    $.each(data, function(index, val) {
                        ...
                        // html +=
                        //     "<img src='<?php echo e(asset('public/storage/')); ?>/" + val['candidate']['user']['avatar'] +
                        //     "'";
                ...
                var lat = "<?php echo e(auth()->user()->company->lat); ?>";
                var lng = "<?php echo e(auth()->user()->company->lng); ?>";
        ...
        function initMap() {
            $.ajax({
                url: "<?php echo e(route('company.marker.candidate')); ?>",
                type: 'GET',
    ...
    <script>
        function statusPending(id) {
            ...
            console.log(id);
            var href = '<?php echo e(route('company.get.test', ':id')); ?>';
...
<?php echo $__env->make('companypanel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rameez Ali\Pictures\erec\resources\views/companypanel/pages/map/index.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
    <div class="col-xl-9 col-lg-8 ">
        ...
        <div class="dashboard_content bg-white rounded_10 p-md-4 p-2">
            ...
            <?php if(isset(auth()->user()->candidateEdu)): ?>
                <?php $__currentLoopData = $user->candidateEdu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border-bottom py-3" id="eduDiv-<?php echo e($row->id); ?>">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between">
                                    <h3 class="fw-500 fs-5 mb-1" id="institute-<?php echo e($row->id); ?>"><?php echo e($row->institute); ?>

                                    </h3>
                                    <a class="me-3 d-inline-block ms-auto text_grey_999" role="button"
                                        onclick="btn_edit(<?php echo e($row->id); ?>)" data-bs-toggle="tooltip"
                                ...
                                <h4 class="fw-500" id="education-<?php echo e($row->id); ?>"><?php echo e($row->education); ?> -
                                    <?php echo e($row->course); ?></h4>
                        ...
                        ?>
                                    <span id="year-<?php echo e($row->id); ?>">Passing year -
                                ...
                                <div class="text_grey_999 fs-14 mt-1 d-flex align-items-center" style="gap: 0 8px;">
                                    ...
                                    <span id="location-<?php echo e($row->id); ?>"><?php echo e($row->institute_loc); ?></span>
                                </div>
                                
                                <div class="mt-3 fw-500" id="grade-<?php echo e($row->id); ?>">
                                    <?php if($row->grade != null): ?>
                                        Grade: <?php echo e($row->grade); ?>

                                    <?php endif; ?>
                                </div>
                                <p class="text_grey_999 fs-14 mt-3" id="description-<?php echo e($row->id); ?>">
...
<?php $__env->startSection('bottom_script'); ?>
    <script>
        function btn_edit(value) {
            console.log(value);
            var url = '<?php echo e(route('candidates.educationupdate', ':id')); ?>';
        ...
        function callModal(id) {
            // console.log(id);
            var href = '<?php echo e(route('candidates.education.delete', ':id')); ?>';
            ...
            Swal.fire({
                    ...
                    confirmButtonText: "<a class='text-white' id='delete-edu' href='<?php echo e(route('candidates.education.delete', '')); ?>/" +
                        id +
                        "'>Yes</a>",
                    cancelButtonText: 'No',
                })
        ...
        $(document).ready(function() {
            ...
            $('.dashboard-form').on('submit', function(e) {
                ...
                // {
                $.ajax({
                        url: "<?php echo e(route('candidates.education.update')); ?>",
                        type: "POST",
                        data: userFormData,
                        dataType: "json",
                        encode: true,
...
<?php echo $__env->make('candidatepanel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/candidatepanel/pages/education.blade.php ENDPATH**/ ?>
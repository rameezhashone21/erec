  ...
  <div class="dashboard_content bg-white rounded_10 p-4">
    ...
    <div class="d-md-flex aling-items-center mb-3">
      ...
      <button id="importButton" type="button" 
        ...
        <a href="<?php echo e(route('recruiter.exam.question.create', ['id' => $exam->id])); ?>" role="button"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content p-4">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo e(route('recruiter.exam.uploadCSV')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
              ...
              <div class="d-flex ">
                ...
                <div class="dropdown me-3 align-self-center">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li class="px-3 pb-3">
                    <form action="<?php echo e(route('recruiter.exam.question.remove')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/livewire/recruiter/show-question-answers.blade.php ENDPATH**/ ?>
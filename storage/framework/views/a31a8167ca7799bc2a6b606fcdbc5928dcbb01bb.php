...
<style>
  ...
  <div class="col-xl-9 col-lg-8">
    ...
    <div class="dashboard_content bg-white rounded_10 p-4">
      ...
      <form class="dashboard-form needs-validation" method="post" action="<?php echo e(route('company.jobs.update')); ?>"
        ...
        <div class="row gy-4">
          <div class="col-md-6">
            <div class="form-group position-relative">
              ...
              <input type="text" autocomplete="off" class="form-control" value="<?php echo e($post->post); ?>" id="title__search"
                name="post" required>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="offer_salary" class="form-label fs-14 text-theme-primary fw-bold"> Base
                Salary*</label>
              <input type="number" class="form-control" name="offer_salary" value="<?php echo e($post->offer_salary); ?>"
                required>
              <div class="invalid-feedback">
            ...
            <div class="form-group">
              ...
              <div class="position-relative">
                <input type="text" class="form-control fs-14 h-50px datepickerJob readonly" name="expiry_date"
                  id="expiry_date" value="<?php echo e(\Carbon\Carbon::parse($post->expiry_date)->isoFormat('DD-MM-YYYY')); ?>"
                  placeholder="<?php echo e($post->expiry_date); ?>" required>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <?php if($post->banner != null): ?>
                <img src="<?php echo e(asset('storage/' . $post->banner)); ?>" alt="" width="150px" style=""
                  height="70px">
              <?php else: ?>
            ...
            <div class="form-group set-cross-icon">
              ...
              <select data-placeholder="Please Select Recruiter" name="rec_id" id="recruiter"
                ...
                <?php $__currentLoopData = $recruiter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($row->recruiter->id); ?>" <?php if($row->recruiter->id == $post->rec_id): ?> selected <?php endif; ?>>
              ...
              <select name="test_id" class="select2-multiple form-control fs-14  h-50px">
                ...
                <?php if($test_id != null): ?>
                  <?php $__currentLoopData = $test_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <option value="<?php echo e($row['id']); ?>" <?php if($post->test_id == $row['id']): ?> Selected <?php endif; ?>>
...
<?php echo $__env->make('companypanel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/companypanel/pages/jobs/editPost.blade.php ENDPATH**/ ?>
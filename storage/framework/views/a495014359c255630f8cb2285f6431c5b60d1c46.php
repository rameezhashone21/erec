  ...
  <div class="col-xl-9 col-lg-8">
    ...
    <div class="dashboard_content bg-white rounded_10 p-4">
      ...
      <form class="dashboard-form needs-validation" method="POST"
        action="<?php echo e(route('company.exam.question.create', ['id' => $exam->id])); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('companypanel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/companypanel/pages/exam-question/add.blade.php ENDPATH**/ ?>
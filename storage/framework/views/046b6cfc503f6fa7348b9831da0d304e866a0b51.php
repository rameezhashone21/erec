    ...
    <div class="col-xl-9 col-lg-8">
        ...
        <div class="dashboard_content bg-white rounded_10 p-4">
            <div class="d-md-flex align-items-center justify-content-between my-3 border-bottom pb-3 mb-4">
                ...
                <div>
                    <a href="<?php echo e(route('recruiter.markNotificationsRead')); ?>" class="btn_viewall btn_viewall fw-500 px-4 py-2 d-inline-block">Mark as all read</a>
                </div>
            </div>
            ...
            <?php if($notification->status == "exam_status" || $notification->status == "job_apply"): ?>
                <a href="<?php echo e(route('recruiter.job.applicantsById', ['id' => $notification->job_id, 'notification_id' => $notification->id])); ?>" class="notifications__wrapper unread">
            <?php else: ?>
                <a href="<?php echo e(route('recruiter.companyIndex.notification',['notification_id' => $notification->id])); ?>" class="notifications__wrapper unread">
            <?php endif; ?>
            ...
            <?php if($notification->read != 0): ?> 
            <?php if($notification->status == "exam_status" || $notification->status == "job_apply"): ?>
                <a href="<?php echo e(route('recruiter.job.applicantsById', ['id' => $notification->job_id, 'notification_id' => $notification->id])); ?>" class="notifications__wrapper">
            <?php else: ?>
                <a href="<?php echo e(route('recruiter.companyIndex.notification', ['notification_id' => $notification->id])); ?>" class="notifications__wrapper">
            <?php endif; ?>
                <div class="d-flex align-items-center w-100">
                    <div class='me-3'>
                        <img src="<?php echo e(asset('storage/'.$sender_image)); ?>" alt=""
...
<?php echo $__env->make('recruterpanel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/recruterpanel/pages/notifications/index.blade.php ENDPATH**/ ?>
                                        ...
                                        <?php $__currentLoopData = $cand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-lg-4 hiddenDiv">
                                                <div class="new_candidate_box ">
                                                    ...
                                                    <?php if(isset($row->user->avatar)): ?>
                                                        <img src="<?php echo e(asset('public/storage/' . $row->user->avatar)); ?>"
                                            ...
                                            <div class="col-lg-4 hiddenDiv">
                                                <div class="new_candidate_box ">
                                                    ...
                                                    <?php if(isset($row->logo)): ?>
                                                        <img src="<?php echo e(asset('public/storage/' . $row->logo)); ?>"
                                                            alt="profile-img" class="profile img-fluid">
                                                    <?php else: ?>
                                                ...
                                                <div class="new_candidate_box ">
                                                    <a href="" class="">
                                                        <?php if(isset($row->avatar)): ?>
                                                            <img src="<?php echo e(asset('public/storage/' . $row->avatar)); ?>"
                                                                alt="profile-img" class="profile img-fluid">
                                                        <?php else: ?>
                                                            <img src="<?php echo e(asset('images/profile-img.png')); ?>"
                                                                alt="profile-img" class="profile img-fluid">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erec\resources\views/pages/searchKeywordView.blade.php ENDPATH**/ ?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content p-4">
            <div class="modal-header d-block border-0">
                ...
                <p class="mt-3">
                    Please Ensure The File You Upload Is Similar To The Sample, And It Should Be In CSV File Format.
                </p>
            </div>
            <div class="modal-body">
                <form method="post" action="<?php echo e(route('company.exam.uploadCSV')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-12" id="uploadWrapper">
                            <label class="upload__wrapper d-block" for="cvFile">
                                <div class="mb-4">
                                    <img src="http://127.0.0.1:8000/images/Upload-cv-builder.png" alt="" class="img-fluid">
                                </div>
                                <p>
                        ...
                        <div class="col-lg-6" id="uploadContainer" style="display: none;">
                            <div class="d-flex w-100 gap-3">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="41.211" height="54.73" viewBox="0 0 41.211 54.73">
                                        <g id="Group_2654" data-name="Group 2654" transform="translate(1.5 1.5)">
                                            <g id="Icon_feather-file" data-name="Icon feather-file">
                                                <path id="Path_52" data-name="Path 52" d="M27.493,3H10.776A4.987,4.987,0,0,0,6,8.173V49.557a4.987,4.987,0,0,0,4.776,5.173H39.434a4.987,4.987,0,0,0,4.776-5.173V21.106Z" transform="translate(-6 -3)" fill="none" stroke="#007ba7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path>
                                                <path id="Path_53" data-name="Path 53" d="M19.5,3V21.106H37.606" transform="translate(0.605 -3)" fill="none" stroke="#007ba7" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path>
                                            </g>
                                ...
                                <span class="remove-file-icon" id="removeFile" style="cursor: pointer; font-size: 24px;">&times;</span>
                    ...
                    <div class="text-center mt-4">
                        ...
                        <button type="submit" class="btn_viewall disabled fw-500 px-4 py-2" id="uploadButton" style="display: none;">
                            Upload
                        </button>
                    </div>
                </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const dropZone = document.querySelector('#uploadWrapper');
...
<script>
    ...
    const fileNameDisplay = document.getElementById('file__name');
    const fileSizeDisplay = document.getElementById('file__size');
    ...
    cvFileInput.addEventListener('change', function() {
        if (cvFileInput.files.length > 0) {
            ...
            $('#downloadSample').removeClass('d-none');

        }
    });

    removeFileButton.addEventListener('click', function() {
        cvFileInput.value = ''; // Clear the file input
        uploadWrapper.style.display = 'block';
        uploadContainer.style.display = 'none';
        uploadButton.style.display = 'none';
        removeFileButton.style.display = 'none';
        removeDownloadButton = 'inline-block';
        $('#textDownloadSample').removeClass('d-none');
        $('#downloadSample').removeClass('d-none');
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\Users\Rameez Ali\Documents\erec1\resources\views/livewire/company/show-question-answers.blade.php ENDPATH**/ ?>
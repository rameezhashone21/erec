<div class="modal fade" id="myModal6" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="heading">
        ...
        <form class="dashboard-form needs-validation" action="<?php echo e(route('update-question-data')); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/modals/example-modal-6.blade.php ENDPATH**/ ?>
                            ...
                            <select name="test_id" class="select2-multiple form-control fs-14  h-50px">
                                ...
                                <?php if($test_id != null): ?>
                                    <?php $__currentLoopData = $test_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <option value="<?php echo e($row['id']); ?>" 
                                            <?php echo e($row['id'] == $selected_exam->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('companypanel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erec\resources\views/companypanel/pages/jobs/postAnExisting/create.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
  <div class="col-xl-9 col-lg-8">
    ...
    <div class="dashboard_content bg-white rounded_10 p-4">
      ...
      <form class="dashboard-form needs-validation" method="post" action="<?php echo e(route('recruiter.exam.create')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row gy-4">
          <div class="col-md-6">
...
<?php echo $__env->make('recruterpanel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/recruterpanel/pages/exam/add.blade.php ENDPATH**/ ?>
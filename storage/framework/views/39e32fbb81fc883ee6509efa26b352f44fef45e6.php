...
<head>
    ...
    <link href="<?php echo e(asset('css/style.css')); ?>" rel="stylesheet" rel="preload" as="style" />
    ...
    <script>
        $(document).ready(function() {
            var href = '<?php echo e(route('getCategoriesApi')); ?>';
            ...
            $.ajax({
                ...
                $.each(data, function(index, value) {
                    ...
                    if(index < 9)
                    {
                        html += "<li><a href='<?php echo e(route('job.browse')); ?>?job_cat%5B%5D=" + value.id + "'>" + value.title + "</a></li>";
                        $('#implode').html(html);
                    }
                });
        ...
        function wishlist_singlePost(id) {
            ...
            var href = '<?php echo e(route('candidates.wishlist', ':id')); ?>';
...
<body>
    ...
    <div>
        ...
        <?php if(!Route::is('register') && !Route::is('login') && !Route::is('password.request')): ?>
                                ...
                                <?php $__currentLoopData = auth()->user()->resume; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="d-block">
                                        <label class="wrap">
                                            ...
                                            <div for="cv-file" class="cv__name"><?php echo e($row->document_name); ?></div>
                                        </label>
                                    </li>
    ...
    <script>
        ...
        $('#resetButton').click(() => {
            ...
            let url = "<?php echo e(route('job.browse')); ?>";
        ...
        $('#resetCand').click(() => {
            ...
            let url = "<?php echo e(route('candidates.list')); ?>";
            document.location.href = url;
        })
        $('#searchPageReset').click(() => {
            ...
            let url = "<?php echo e(route('search.Keyword.view')); ?>";
            document.location.href = url;
        })
        $('#employerReset').click(() => {
            ...
            let url = "<?php echo e(route('employer.list')); ?>";
            document.location.href = url;
        })
        $('#recruiterReset').click(() => {
            ...
            let url = "<?php echo e(route('recruiter.list')); ?>";
            document.location.href = url;
        })
    </script>
    <script>
            ...
            if (input.files && input.files[0]) {
                ...
                if (fileTypeExt == 'docx' || fileTypeExt == 'doc' || fileTypeExt == 'pdf') {
                    reader.onload = function(e) {
                        ...
                        if (fileTypeExt == 'docx') {
                            $('.file-upload-image').attr('src', "<?php echo e(asset('imgs/icon-docx.png')); ?>");
                        } else if (fileTypeExt == 'doc') {
                            $('.file-upload-image').attr('src', "<?php echo e(asset('imgs/icon-doc.png')); ?>");
                        } else if (fileTypeExt == 'pdf') {
                            $('.file-upload-image').attr('src', "<?php echo e(asset('imgs/icon-pdf.png')); ?>");
                        }
                    };
...
<?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/layouts/app.blade.php ENDPATH**/ ?>
...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('dashboard/css/intlTelInput.min.css')); ?>">
  <!-- input type phone jquery -->
...
<body>
  ...
  <?php if(!Route::is('get.pdf.file')): ?>
    <?php echo $__env->make('candidatepanel.includes.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <?php endif; ?>
  ...
  <main class="bg-light">
        ...
        <div class="cover-edit-box global_cover">
          <div class="cover_picture ">
            ...
            <?php if(isset(auth()->user()->banner)): ?>
              <img src="<?php echo e(asset('storage/' . auth()->user()->banner)); ?>" alt="profile-img" id="output">
            <?php else: ?>
              <img src="<?php echo e(asset('dashboard/images/candidate.png')); ?>" id="output" />
            <?php endif; ?>
          </div>
        </div>
      </form>
    ...
    <div class="container margin-top-minus-all position-relative">
      <div class="row">
        ...
        <?php if(!Route::is('get.pdf.file')): ?>
          <?php echo $__env->make('candidatepanel.includes.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
      ...
      <div class="file-upload">
        <div class="file_upload_inner_div">
          ...
          <div class="file-upload-wrap">
            <form method="post" action="<?php echo e(route('candidates.applyNow')); ?>" enctype="multipart/form-data"
              name="myForm">
              <?php echo csrf_field(); ?>
              ...
              <?php if(count(auth()->user()->resume) < 6): ?>
              ...
              <div class="cv-list">
                <ul>
                  <?php $__currentLoopData = auth()->user()->resume; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="d-block">
                      <label class="wrap">
                        
                        <input type="radio" id="cv-file-<?php echo e($row->id); ?>" name="cv_file"
                        ...
                        <div for="cv-file" class="cv__name"><?php echo e($row->document); ?></div>
                      </label>
                    </li>
  ...
  <?php echo $__env->make('candidatepanel.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <!-- input type phone jquery -->
  <script src="<?php echo e(asset('/dashboard/js/intlTelInput-jquery.min.js')); ?>"></script>
  <!-- input type phone jquery -->
  ...
  <script>
    ...
    $('.editSkill').click(function() {
      $.ajax({
          type: "GET",
          url: "<?php echo e(route('candidates.getSkills')); ?>",
        }).done(function(data) {
          ...
          reader.onload = function(e) {
            ...
            if (fileTypeExt == 'docx') {
              $('.candidate_apply_modal .file-upload-image').attr('src',
                "<?php echo e(asset('imgs/icon-docx.png')); ?>");
            } else if (fileTypeExt == 'doc') {
              $('.candidate_apply_modal .file-upload-image').attr('src',
                "<?php echo e(asset('imgs/icon-doc.png')); ?>");
            } else if (fileTypeExt == 'pdf') {
              $('.candidate_apply_modal .file-upload-image').attr('src',
                "<?php echo e(asset('imgs/icon-pdf.png')); ?>");
            }
          };
...
<?php /**PATH /home/backendhostingla/public_html/webapp/erec/resources/views/candidatepanel/layout/app.blade.php ENDPATH**/ ?>
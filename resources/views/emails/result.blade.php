                                    ...
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                            ...
                                            <div
                                                ...
                                                <p style="line-height: 140%;"><br />User {{$data['username']}} has attempted the test for the postion of {{$data['position']}}</p>
                                                <p style="line-height: 140%;"><br />He has {{$data['status']}} the test with grade {{$data['grade']}} ({{round($data['percentage'], 2)}})</p>
                                            </div>

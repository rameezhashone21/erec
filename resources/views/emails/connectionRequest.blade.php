                                    ...
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                            ...
                                            <h1
                                                ...
                                                {{ $sender }} sent you a connection</h1>
                                    ...
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                            ...
                                            <div
                                                ...
                                                <p style="line-height: 140%;">Hi {{ $reciever }},</p>
                                                <p style="line-height: 140%;"><br />{{ $sender }} wants to connect with you on
                                                    E-REC</p>
                                            </div>
                                    ...
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                            ...
                                            <div
                                                ...
                                                <p style="line-height: 140%;"><strong>{{ $sender }}</strong></p>
                                                <p style="line-height: 140%;"> </p>
                                    ...
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                            ...
                                            <div align="left">
                                                ...
                                                {{-- <a href="{{ $confirm }}" target="_blank" class="v-button" --}}
                                                <a href="{{ route('recruiters.accept', $confirm) }}" target="_blank" class="v-button"

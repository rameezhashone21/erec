...
<style>
  ...
  <div class="col-xl-9 col-lg-8">
    ...
    <div class="dashboard_content bg-white rounded_10 p-4">
      ...
      <form class="dashboard-form needs-validation" method="post" action="{{ route('company.jobs.update') }}"
        ...
        <div class="row gy-4">
          <div class="col-md-6">
            <div class="form-group position-relative">
              ...
              <input type="text" autocomplete="off" class="form-control" value="{{ $post->post }}" id="title__search"
                name="post" required>
          ...
          {{-- <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group set-cross-icon" id="testBox">
                            <label for="test_id" class="form-label fs-14 text-theme-primary fw-bold">Attach a test</label>
                                ...
                                @if ($test_id != null)
                                    @foreach ($test_id as $row)
                                        <option value="{{ $row['number'] }}"
                                            @if ($post->test_id == $row['number']) Selected @endif>{{ $row['name'] }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
          ...
          <div class="col-md-6">
            <div class="form-group set-cross-icon ">
              ...
              <select class="form-select select2-multiple fs-14 h-50px" name="job_type" required>
                ...
                <option value="Graduate" @if ($post->job_type == 'Graduate') selected @endif>Graduate
                </option>
          ...
          <div class="col-md-6">
            <div class="form-group set-cross-icon">
              ...
              {{-- <input type="text" class="form-control" value="{{ $post->experience }}" name="experience"
                                required> --}}
              <select class="form-select select2-multiple fs-14 h-50px" name="experience" required>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="offer_salary" class="form-label fs-14 text-theme-primary fw-bold"> Base
                Salary*</label>
              <input type="number" class="form-control" name="offer_salary" value="{{ $post->offer_salary }}"
                required>
              <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="position-relative">
                <input type="text" class="form-control fs-14 h-50px datepickerJob readonly" name="expiry_date"
                  id="expiry_date" value="{{ \Carbon\Carbon::parse($post->expiry_date)->isoFormat('DD-MM-YYYY') }}"
                  placeholder="{{ $post->expiry_date }}" required>
                <label class="calender-icon d-block" for="expiry_date">
            ...
            {{-- <div class="form-group">
                            <label for="expiry_date" class="form-label ">Valid Till*</label>
                            <input type="date" class="form-control " value="{{ $post->expiry_date }}"
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input id="searchInput" value="{{ $post->location }}"
                class="controls form-control input-login searchInput" name="address" type="text" placeholder=""
          ...
          <div class="col-md-6">
            <div class="form-group set-cross-icon">
              ...
              {{-- <input type="text" class="form-control" value="{{ $post->qualification }}"
                                name="qualification" required> --}}
              <select class="form-select select2-multiple fs-14 h-50px" name="qualification" required>
                <option selected disabled value="">Please Select Qualification</option>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <textarea class="form-control" id="key_responsibility" name="key_responsibility" required>{!! $post->key_responsibility !!}</textarea>
              <div class="invalid-feedback">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="skill_exp" class="form-label fs-14 text-theme-primary fw-bold">Skills &
                Experience*</label>
              <textarea class="form-control" name="skill_exp" required>{!! $post->skill_exp !!}</textarea>
              <div class="invalid-feedback">
            ...
            <div class="form-group set-cross-icon">
              ...
              <select name="skill[]" id="skill" class="editSkillsJob form-select fs-14  h-50px" required
                ...
                @foreach ($skill as $row)
                  <option value="{{ $row->id }}"
                    @if ($postSkills != null) @foreach ($postSkills as $ps)
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              @if ($post->banner != null)
                <img src="{{ asset('storage/' . $post->banner) }}" alt="" width="150px" style=""
                  height="70px">
              @else
          ...
          <div class="col-md-6">
            <div class="form-group set-cross-icon">
              <label for="" class="form-label fs-14 text-theme-primary fw-bold">Assign
                Recruiter</label>
              <select data-placeholder="Please Select Recruiter" name="rec_id" id="recruiter"
                class="select2-multiple form-select fs-14 h-50px">
                <option></option>
                @foreach ($recruiter as $row)
                  <option value="{{ $row->recruiter->id }}" @if ($row->recruiter->id == $post->rec_id) selected @endif>
                    {{ $row->recruiter->name }}
                  </option>
                @endforeach
              </select>
            ...
            <div class="form-group set-cross-icon" id="testBox">
              ...
              <select name="test_id" class="select2-multiple form-control fs-14  h-50px">
                ...
                @if ($test_id != null)
                  @foreach ($test_id as $row)
                    {{-- {{ dd($row) }} --}}
                    <option value="{{ $row['id'] }}" @if ($post->test_id == $row['id']) Selected @endif>
                      {{ $row['exam_title'] }}
                    </option>
                  @endforeach
                @endif
...
@section('bottom_script')
  ...
  <script>
    ...
    function testFillBox() {
      var id = $('#class_id').val();
      var href = "{{ route('company.get.testCreate', ':id') }}";

...
@section('content')
    <div class="col-xl-9 col-lg-8 col-md-7">
        ...
        <div class="dashboard_content bg-white rounded_10 p-4">
            ...
            <form class="dashboard-form needs-validation" method="post" action="{{ route('company.jobs.store') }}"
                ...
                <div class="row gy-4">
                    <div class="col-md-6">
                        <div class="form-group position-relative">
                            ...
                            <input type="text" autocomplete="off" class="form-control" value="{{ $post->post }}"
                    ...
                    {{-- <div class="col-md-6">
                        <div class="form-group set-cross-icon">
                            ...
                            <select data-placeholder="Please Select Increments"
                                class="form-control select2-multiple fs-14 h-50px" name="increment" required>
                                <option></option>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            @if ($post->banner != null)
                                <img src="{{ asset('public/storage/' . $post->banner) }}" alt=""
                        ...
                        <div class="form-group set-cross-icon">
                            ...
                            <select name="rec_id" id="recruiter" data-placeholder="Please Select Recruiter"
                                ...
                                @foreach ($recruiter as $row)
                                    <option value="{{ $row->recruiter->id }}"
                                        @if ($row->recruiter->id == $post->rec_id) selected @endif>
                                        {{ $row->recruiter->name }}
                                    </option>
                                @endforeach
                            </select>

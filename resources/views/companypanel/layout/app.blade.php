...
<body>
  ...
  <main class="bg-light position-relative">
        ...
        <div class="cover_picture ">
          {{-- <label class="-label" for="file">
                    ...
                    <input id="file" type="file" onchange="loadFile(event)" class="file-upload"
                        name="banner" />
                    <img src="{{ asset('dashboard/images/Company.png') }}" id="output" /> --}}
          <form id="msform" class="avatar-form" name="change_avatar" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="source" value="api" />
            <label class="-label" for="file">
    ...
    {{-- @if (isset(auth()->user()->banner))
            <img src="{{ asset('public/storage/' . auth()->user()->banner) }}" alt="profile-img" class="w-100 banner__image">
        @else
            <img src="https://check.hostingladz.com/webapp/Erec/images/banner-placeholder.png" alt=""
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="position-relative mb-4">
              <input type="checkbox" onchange="disabledDiv()" id="newPost" name="jobPost" class="post-job-radio"
                checked>
  ...
  <script>
    ...
    function checkExistingId(id) {
      ...
      html += "href='{{ route('company.existing.job', '') }}/" + id + "'>Next</a>";
    ...
    function disabledDiv() {
      ...
      if (newPost.checked) {
        ...
        var html = "";
        html += "<a class='btn_viewall btn_viewall fw-500 px-4 py-2 d-inline-block ms-auto'";
        html += "href='{{ route('company.jobs.create') }}'>Next</a>";
        $('.modal-footer').html('');
        $('.modal-footer').html(html);
      }
    }

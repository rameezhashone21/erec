            ...
            <div class="col-lg-7">
                <div class="dashboard_content bg-white rounded_10 p-md-4 p-2">
                    ...
                    <ul class="d-flex cv-perse-navigation">
                        ...
                        <li>
                            <a href="{{ route('candidates.cvParser.skills') }}" class="active">Skills</a>
                        </li>
                        <li>
                    ...
                    <form method="POST" class="cv_parse_form" action="{{ route('candidates.cvParser.update.data') }}"
                        ...
                        <input type="hidden" name="cv_builder_id" value="{{ $skills->id }}" />
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-12 d-flex align-items-center justify-content-between">
                                <div>
                                    <a href="{{ route('candidates.cvParser.contact') }}"
                    ...
                    <div class="cv-view position-relative">
                        ...
                        <div class="cv-view-body position-relative">
                            @if ($skills->contact->cv_profile != null)
                                <img src="{{ asset('public/storage/' . $skills->contact->cv_profile) }}" alt="profile"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <h3 class="cv-profile-name">{{ $skills->contact->name }}
                                        {{ $skills->contact->father_name }}
                                    </h3>
                                    <h4 class="cv-profile-title"> {{ $skills->contact->title }}</h4>
                                </div>

            ...
            <div class="col-lg-7">
                <div class="dashboard_content bg-white rounded_10 p-md-4 p-2">
                    ...
                    <ul class="d-flex cv-perse-navigation">
                        <li>
                            <a href="{{ route('candidates.cvParser.contact') }}" class="active">Contact</a>
                        </li>
                        <li>
                    ...
                    <form method="POST" class="cv_parse_form" action="{{ route('candidates.cvParser.update.data') }}"
                        ...
                        <div class="row gy-4">
                            <div class="col-12">
                                <label for="imageUpload" class="avatar-upload d-inline-flex align-items-center gap-3">
                                    <div class="avatar-preview">
                                        ...
                                        @else
                                            <div id="imagePreview"
                                                style="background-image: url({{ asset('/images/image_preview_noimage.png') }});">
                                            </div>
                                        @endif
                                    </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" id="firstName" name="name" value="{{ $contact->contact->name }}"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" id="lastName" name="father_name"
                                    value="{{ $contact->contact->father_name }}" class="form-control cv-parse-input">
                            </div>
                            <div class="col-lg-6">
                                ...
                                <input type="text" id="designationTitle" name="title"
                                    value="{{ $contact->contact->title }}" class="form-control cv-parse-input">
                            </div>
                            <div class="col-lg-6">
                                <label for="emailAddress" class="cv-parse-lable mb-2">Email Address</label>
                                <input type="email" id="emailAddress" name="email"
                                    value="{{ $contact->contact->email }}" class="form-control cv-parse-input">
                            </div>
                            <div class="col-lg-6">
                                <label for="phoneNumber" class="cv-parse-lable mb-2">Phone Number</label>
                                <input type="text" id="phoneNumber" value="{{ $contact->contact->phone }}"
                ...
                <div class="sticky__div">
                    <div class="cv-view position-relative" style="word-break: break-word;">
                        ...
                        <div class="cv-view-body position-relative">
                            @if ($contact->contact->cv_profile != null)
                                <img src="{{ asset('public/storage/' . $contact->contact->cv_profile) }}" alt="profile"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <h3 class="cv-profile-name text-capitalize">
                                        <span id="firstNameView">{{ $contact->contact->name }}</span>
                                        <span id="middleNameView"></span>
                                        <span id="lastNameView">{{ $contact->contact->father_name }}</span>
                                    </h3>
                                    <h4 class="cv-profile-title" id="designationTitleView">{{ $contact->contact->title }}
                                    </h4>
                                </div>
                            ...
                            {{-- <hr> --}}
                            {{-- <div>
                                <h3 class="cv-profile-name mb-2">About</h3>

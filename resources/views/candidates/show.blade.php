            ...
            <div class="row gy-4 gy-lg-0">
                <div class="col-lg-3 sidebar_container">
                    <div class="side_bar bg-white position-relative rounded_10 side_bar_top view_profile_box pb-4">
                        ...
                        <div class="text-center">
                            ...
                            @if ($user->candidate->tagline != null)
                                <p class="mb-0 px-3 fs-14">
                                    {{ $user->candidate->tagline }}
                                </p>
                            @endif
                            <p class="mb-0 px-3 fs-14">
                                @if (isset($user->candidatePro) && count($user->candidatePro) > 0)
                                    {{ $user->candidatePro[0]->designation }}
                                @endif
                            </p>
                        </div>
                        <div>
                        ...
                        <ul class="side_bar_menu view_profile_sidebar px-3" id="side_bar_view">
                            @if ($user->candidate->address != null)
                                @if ($user->candidate->address_status == 'Public')
                                    <li>
                                        <a href="javascript:;" class="d-flex align-items-center">
                                            ...
                                            @else
                                                <span style="font-size: 10px; color: transparent; text-shadow: 0 0 8px #000"
                                                    ;>{{ $user->candidate->address }}</span>
                                            @endif
                                        </a>
                                    </li>
                                @elseif ($user->candidate->address_status == 'Employers')
                                    ...
                                    @endif
                                @elseif ($user->candidate->address_status == 'Recruiters')
                                    @if (Auth::check() and auth()->user()->role == 'rec')
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="19.182" height="23"
                                    ...
                                    @endif
                                @elseif ($user->candidate->address_status == 'Employers/Recruiters')
                                    @if (Auth::check() and auth()->user()->role == 'rec' or Auth::check() and auth()->user()->role == 'company')
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="19.182" height="23"
                                    ...
                                    @endif
                                @elseif ($user->candidate->address_status == 'Only Me')
                                ...
                                @endif
                            @endif
                            @if ($user->candidate->email != null)
                                @if ($user->candidate->email_status == 'Public')
                                    <li>
                                        <a href="javascript:;" class="d-flex align-items-center">
                                            <span>
                                            ...
                                            @if (Auth::check())
                                                <span class="word-break-all">{{ $user->candidate->email }}</span>
                                            @else
                                                <span
                                                    style="font-size: 10px; color: transparent; text-shadow: 0 0 8px #000"
                                                    ;>{{ $user->candidate->email }}</span>
                                            @endif
                                        </a>
                                    </li>
                                @elseif ($user->candidate->email_status == 'Employers')
                                    @if (Auth::check() and auth()->user()->role == 'company')
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                                                ...
                                                @if (Auth::check())
                                                    <span>{{ $user->candidate->email }}</span>
                                                @else
                                                    <span
                                                        style="font-size: 10px; color: transparent; text-shadow: 0 0 8px #000"
                                                        ;>{{ $user->candidate->email }}</span>
                                    ...
                                    @endif
                                @elseif ($user->candidate->email_status == 'Recruiters')
                                    @if (Auth::check() and auth()->user()->role == 'rec')
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                                    ...
                                    @endif
                                @elseif ($user->candidate->email_status == 'Employers/Recruiters')
                                    @if (Auth::check() and auth()->user()->role == 'rec' or Auth::check() and auth()->user()->role == 'company')
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                                    ...
                                    @endif
                                @elseif ($user->candidate->email_status == 'Only Me')
                                    @if (Auth::check() and auth()->user()->id == $user->id)
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                                ...
                                @endif
                            @endif
                            @if ($user->candidate->number != null)
                                @if ($user->candidate->phone_status == 'Public')
                                    <li>
                                        <a href="javascript:;" class="d-flex align-items-center">
                                            <span>
                                            ...
                                            @if (Auth::check())
                                                <span>{{ $user->candidate->country_code . ' ' . $user->candidate->number }}</span>
                                            @else
                                                {{-- <span>ph******</span> --}}
                                                <span>
                                                    {{ \Illuminate\Support\Str::limit($user->candidate->country_code . ' ' . $user->candidate->number, 6, $end = '****') }}
                                                </span>
                                            @endif
                                        </a>
                                    </li>
                                @elseif ($user->candidate->phone_status == 'Employers')
                                    ...
                                    @endif
                                @elseif ($user->candidate->phone_status == 'Recruiters')
                                    @if (auth()->check() && auth()->user()->role == 'rec')
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18.405"
                                    ...
                                    @endif
                                @elseif ($user->candidate->phone_status == 'Employers/Recruiters')
                                    @if (auth()->check() && auth()->user()->role == 'rec' or Auth::check() and auth()->user()->role == 'company')
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18.405"
                                    ...
                                    @endif
                                @elseif ($user->candidate->phone_status == 'Only Me')
                                    @if (Auth::check() and auth()->user()->id == $user->id)
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                            ...
                            <li>
                                <a href="javascript:;" class="d-flex align-items-center">
                                    ...
                                    <span>Joined
                                        {{ \Carbon\Carbon::parse($user->created_at)->formatLocalized('%b %Y') }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:;" class="d-flex align-items-center">
                                    ...
                                    {{-- {{ dd($user->candidatePro) }} --}}
                                    @if (isset($user->candidatePro) && count($user->candidatePro) > 0)
                                        <span>Working at {{ $user->candidatePro[0]->company_name }}</span>
                                    @endif
                                </a>
                            </li>
                            <li>
                                <a href="javascript:;" class="d-flex align-items-center">
                                    ...
                                    <span>{{ $user->candidate->marital_status }}</span>
                                </a>
                            </li>
                            @if ($user->candidate->visa_status != null)
                                @if ($user->candidate->visa_status_status == 'Public')
                                    <li>
                                        <a href="javascript:;" class="d-flex align-items-center">
                                            <span>
                                            ...
                                            <span>{{ $user->candidate->visa_status }}</span>
                                        </a>
                                    </li>
                                @elseif ($user->candidate->visa_status_status == 'Employers')
                                    @if (auth()->check() && auth()->user()->role == 'company')
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                                    ...
                                    @endif
                                @elseif ($user->candidate->visa_status_status == 'Recruiters')
                                    @if (auth()->check() && auth()->user()->role == 'rec')
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                                    ...
                                    @endif
                                @elseif ($user->candidate->visa_status_status == 'Employers/Recruiters')
                                    @if (auth()->check() && auth()->user()->role == 'rec' or Auth::check() and auth()->user()->role == 'company')
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                                    ...
                                    @endif
                                @elseif ($user->candidate->visa_status_status == 'Only Me')
                                    @if (Auth::check() and auth()->user()->id == $user->id)
                                        <li>
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                <span>
                        ...
                        @if (Auth::check())
                            @if (auth()->user()->role == 'rec' || auth()->user()->role == 'company')
                                @if (isset($user->resume) && count($user->resume) > 0)
                        ...
                        <div class=" d-flex justify-content-around view_profile_socials  mt-4 px-3">
                            ...
                            @if ($user->candidate->facbookLink == !null)
                                <a href="{{ $user->candidate->facbookLink }}" target="_blank">
                            ...
                            @endif
                            @if ($user->candidate->instagramLink == !null)
                                <a href="{{ $user->candidate->instagramLink }}" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        viewBox="0 0 20 20">
                                        <path id="instagram"
                            ...
                            @if ($user->candidate->twitterLink == !null)
                                <a href="{{ $user->candidate->twitterLink }}" target="_blank">

                                    <i class="fab fa-twitter fs-5" style="padding-top: 4px; color: #007ba7;"></i>
                                </a>
                            @endif
                            @if ($user->candidate->linkdinLink == !null)
                                <a href="{{ $user->candidate->linkdinLink }}" target="_blank">
                ...
                <div class="col-lg-6" id="msg-btn">
                    <div class="view_profile_box content_area p-4">
                        @if (isset($user->candidate->head_line))
                                  ...
                                  <div>
                                    @if(auth()->check())
                                      @if (auth()->user()->role == 'company' || auth()->user()->role == 'rec')
                                          <open-box :openBoxFunction="openBox" :id="{{ $user->id }}"></open-box>
                                      @endif
                                    @endif
                                  </div>
                                </div>
                                <p>{{ $user->candidate->head_line }}</p>
                            </div>
                        @endif
                        @if (isset($user->candidatePro) && count($user->candidatePro) > 0)
                            <h2 class="view_profile_name my-3">Professional Experience</h2>
                            <ul>
                                @foreach ($user->candidatePro as $row)
                                            ...
                                            <li class="d-flex align-items-center">
                                                ...
                                                <span>
                                                    @if ($row->year_exp != 0)
                                                        ...
                                                        @endif
                                                    @else
                                                        <p>{{ \Carbon\Carbon::parse($row->month_exp)->isoFormat('MMM YY') }}
                        ...
                        @endif
                        @if (isset($user->candidateEdu) && count($user->candidateEdu) > 0)
                            <h2 class="view_profile_name my-3">Education</h2>
                            <ul>
                                @foreach ($user->candidateEdu as $row)
                                    <li class="border-bottom pb-3 mb-3">
                                        <p class="view_profile_destination mb-1">{{ $row->institute }}</p>
                                        <h4 class="view_profile_company">{{ $row->education }} - {{ $row->course }}</h4>
                                        <ul class="profile_view_info">
                                            <li class="d-flex align-items-center">
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                ...
                                                <span>
                                                    {{ \Carbon\Carbon::createFromFormat('d/m/Y', $row->passing_year)->formatLocalized('%b %Y') }}
                                                </span>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <span>
                                        ...
                                        @if ($row->grade != null)
                                            <h4 class="view_profile_company">Grade: {{ $row->grade }}</h4>
                                        @endif
                                        @if ($row->description != null)
                                            <p class="view_profile_description">
                                                {!! $row->description !!}

        ...
        <div class="container ">
            <div class="row justify-content-center align-items-center ">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="mb-0 ">
                        Please add the package {{ $pkg->name }} - @if ($pkg->time_interval == 'year')
                            Yearly
                        @else
                            Monthly
                        @endif Package Payment. Our subscription packages offer great value
                        for money.
                    </p>
                </div>
            </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap ">
                                ...
                                {{-- <a class='payment-subcription-btn d-flex justify-content-center align-items-center'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="11.839" height="23.684"
                                        viewBox="0 0 11.839 23.684">
                                        <path id="arrow-ios-back-fill"
                                            d="M9.874,23.684a1.692,1.692,0,0,1-1.319-.626L.385,12.909a1.692,1.692,0,0,1,0-2.148L8.843.611a1.694,1.694,0,1,1,2.6,2.165L3.886,11.843l7.307,9.067a1.692,1.692,0,0,1-1.319,2.774Z"
                                            transform="translate(11.839 23.684) rotate(180)" fill="#fff" />
                                    </svg>
                                </a> --}}
                            </div>
                        </div>
                            ...
                            <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
                                <li class="nav-item flex-w50" role="presentation">
                                    <button class="nav-link active w-100" id="home-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true">
                                        <img src="{{ asset('/images/cards_one.svg') }}" alt="" class='img-fluid'>
                                    </button>
                                </li>
                                <li class="nav-item flex-w50 border-right-0 align-self-end" role="presentation">
                                    <button class="nav-link w-100" id="profile-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false">
                                        <img src="{{ asset('/images/card_two.svg') }}" alt="" class='img-fluid'>
                                    </button>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <div class="py-5 px-4">
                                        ...
                                        {{-- <form id="payment-form" class="mt-4" data-cc-on-file="false"> --}}
                                        <form id="payment-form" class="mt-4"
                                            data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" data-cc-on-file="false">
                                            @csrf
                                            {{-- <input type="hidden" name="payment_method" value="eway" id="payment_method"> --}}
                                            <input type="hidden" name="package" value="{{ $pkg->slug }}"
                                                id="payment_amount">
                                            <div class="row gy-4">
                                                <input type="hidden" name="stripe_packageId" value="">
                                                {{-- <div class="col-12">
                                                    <label for="nameCard" class='mb-2'>Email</label>
                                                    <div class="position-relative"> --}}
                                                <input type="email" hidden id='emailCard'
                                                    name="{{ auth()->user()->email }}" class='form-control payment-input'
                            ...
                            if (response.error) {
                                ...
                                if (1 + 1 == 2) {
                                    ...
                                    var formData = {
                                        ...
                                        card_cvv: $("#cvv_card").val(),
                                        plan_id: "{{ $pkg->id }}",
                                        plan_stripe_id: "{{ $pkg->stripe_price_id }}",
                                        price: "{{ $pkg->price }}",
                                        payment_mode: 'stripe',
                                        email: $("#emailCard").val(),
                                        stripeToken: token,

            ...
            <div class="row row-cols-lg-4 row-cols-md-2 row-cols-1 gy-5" id="one">
                        ...
                        <div class="subcription_list_box position-relative">
                            ...
                            <div class="mb-4 top_package_button">
                                @if (auth()->check())
                                    ...
                                    @else
                                        <a href="{{ route('subscriptionPayment', $trial->id) }}" class="btn_package">Choose
                                            Plan
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                                viewBox="0 0 18 12">
                                    ...
                                    @endif
                                @else
                                    <a href="{{ route('login') }}" class="btn_package">Choose Plan
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                            viewBox="0 0 18 12">
                                            <g id="Group_688" data-name="Group 688" transform="translate(18) rotate(90)">
                                                <path id="Path_5027" data-name="Path 5027"
                            ...
                            <ul class='subcription_list'>
                                <li>
                                    ...
                                    <span class="ps-3">Job Posting. ({{ $trial->no_of_posts }})</span>
                                </li>
                                <li>
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18.785" height="13.513"
                            ...
                            @if (auth()->check())
                                ...
                                @endif
                            @else
                                <a href="{{ route('login') }}" class="btn_package">Choose
                                    Plan
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="12"
                                        viewBox="0 0 18 12">
                                        <g id="Group_688" data-name="Group 688" transform="translate(18) rotate(90)">
                ...
                @foreach ($month as $row)
                    @if ($row->id != 21)
                        <div class="col">
                            <div
                                class="@if ($key1 / $key == 1) @php $key1 = $key1+3 @endphp first @endif @if ($key2 / $key == 1) @php $key2 = $key2+3 @endphp second @endif @if ($key3 / $key == 1) @php $key3 = $key3+3 @endphp third @endif">
                                <div class="package_header text-center">
                                    <h2>
                                        {{ $row->name }}
                                    </h2>
                                ...
                                <div class="subcription_list_box position-relative">
                                    <h3
                                        ...
                                        @endphp
                                        ${{ (int) $total_price }}<span class='ms-2'>/ {{ $row->time_interval }} </span>
                                    </h3>
                                    <div class="mb-4 top_package_button">
                                        @if (Auth::check())
                                            ...
                                            @else
                                                <a href="{{ route('subscriptionPayment', $row->slug) }}"
                                    ...
                                    <ul class='subcription_list'>
                                        <li>
                                            ...
                                            @endif
                                            <span class="ps-3">Job Posting. ({{ $row->no_of_posts }})
                                            </span>
                                        </li>
                                        <li>
                                            @if ($row->applicantProfiling == 1)
                        ...
                        <div class="subcription_list_box position-relative">
                            ...
                            <div class="mb-4 top_package_button">
                                @if (auth()->check())
                                    ...
                                    @else
                                        <a href="{{ route('subscriptionPayment', $trial->id) }}"
                                    ...
                                    <div class="subcription_list_box position-relative">
                                        <h3
                                            ...
                                            @php
                                                ...
                                                $total_price = $price + $tax_price;
                                            @endphp
                                            ${{ (int) $total_price }}<span class='ms-2'>/ {{ $row->time_interval }}
                                            </span></h3>
                                        </h3>
                                        <div class="mb-4 top_package_button">
                                            @if (Auth::check())
                    ...
                    @if ($row->id != 21)
                        <div class="col">
                            <div
                                ...
                                <div class="subcription_list_box position-relative">
                                    <h3 @php
$site = App\Models\SiteSetting::first(); @endphp
                                        class='subcription-prize mx-auto d-flex align-items-center flex-column justify-content-center'>
                                        ${{ $row->price }}<span class='ms-2'>/ {{ $row->time_interval }}</span></h3>
                                    <ul class='subcription_list'>
                                        <li>
                                            @if ($row->applicantProfiling == 1)
                                                <span>
                                        ...
                                        <li>
                                            @if ($row->industryBasedAssessment == 1)
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18.785"
                                                        height="13.513" viewBox="0 0 18.785 13.513">
                                                        <path id="Path_5025" data-name="Path 5025"
                                        ...
                                        <li>
                                            @if ($row->predictiveAnalysisEngine == 1)
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18.785"
                                                        height="13.513" viewBox="0 0 18.785 13.513">
                                                        <path id="Path_5025" data-name="Path 5025"
            ...
            <div class="mt-5 "><i>Note: <span class="text-grey">The pricing of our packages is inclusive of
                        {{ $site->tax_rate }}% (GST) tax</span> </i> </div>
    </section>
@endsection

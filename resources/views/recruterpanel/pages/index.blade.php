@extends('recruterpanel.layout.app') @section('page_title', 'E-Rec')
    ...
    <div class="col-xl-9 col-lg-8">
        ...
        <div class="dashboard_content bg-white rounded_10 p-4">
                ...
                <a href="{{ route('recruiter.companyIndex') }}">
                    <div class="col">
                        <div class="progress_card second_div p-4">
                            ...
                            <h4 class="text-white fs-1 fw-bold">{{ $recRelation }}</h4>
                        </div>
                    </div>
                </a>
                <a href="{{ route('recruiter.jobs') }}">
            ...
            <div class="d-md-flex justify-content-between aling-items-center my-3">
                ...
                <div>
                    <a href="{{ route('job.browse') }}" class="btn_viewall btn_viewall fw-500 px-4 py-2 d-inline-block">View
                        all</a>
                        ...
                        @if (count($jobs) > 0)
                            @foreach ($jobs as $key => $row)
                                <tr>
                                    ...
                                    <td class="set-width-table-2"> {{ $row->experience }}</td>
                                    ...
                                    <td class="set-width-table-4 ">
                                        @if ($row->status != 5)
                                            <a href="{{ route('recruiter.job.details', $row->slug) }}" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="View" class="btn btn_viewall">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('recruiter.jobs.edit', $row->slug) }}" data-bs-toggle="tooltip"

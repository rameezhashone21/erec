                ...
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group set-cross-icon">
                            ...
                            <select data-placeholder="Please Select Experience" class="form-select fs-14 select2-multiple"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="offer_salary" class="form-label fs-14 text-theme-primary fw-bold"> Base
                                Salary*</label>
                            <input type="number" class="form-control fs-14 h-50px" name="offer_salary" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control fs-14 h-50px datepickerJob readonly"
                                    name="expiry_date" id="expiry_date" placeholder="DD/MM/YYYY" autocomplete="off"
                                    required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group set-cross-icon">
                            <label for="" class="form-label fs-14 text-theme-primary fw-bold">Job
                                Duties*</label>
                            <select name="skill[]" id="skill" class="form-select fs-14 editSkillsJob h-50px" required
                                multiple>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <button type="submit" class="btn_viewall btn_viewall fw-500 px-4 py-2 d-inline-block"> Post
                                A
                                Job </button>
                        </div>
                    </div>

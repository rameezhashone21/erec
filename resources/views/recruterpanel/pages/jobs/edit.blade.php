...
<style>
    ...
    <div class="col-xl-9 col-lg-8">
        ...
        <div class="dashboard_content bg-white rounded_10 p-4">
            ...
            <form class="dashboard-form needs-validation" method="post" action="{{ route('recruiter.jobs.update') }}"
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        ...
                        {{-- <div class="form-group">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control fs-14 h-50px datepicker" name="expiry_date"
                                    id="expiry_date" value="{{ $post->expiry_date }}" required readonly>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <img src="{{ asset('storage/' . $post->banner) }}" alt="plus-circle"
                            ...
                            <label for="test_id" class="form-label fs-14 text-theme-primary fw-bold">Select
                                ...
                                @if($test_id != null)
                                    @foreach ($test_id as $row)
                                        <option value="{{ $row['id'] }}"
                                            @if ($post->test_id == $row['id']) Selected @endif>{{ $row['exam_title'] }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>

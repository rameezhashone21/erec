 <!-- Main Navbar -->
 <nav class="navbar align-items-center navbar-light flex-md-nowrap p-0">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
        @if (isset(auth()->user()->recruiter))
            ...
            @else
                <img class="user-avatar rounded-circle mr-2" src="{{asset('adminpanel/images/avatar/dummy.png')}}" alt="">
            @endif
        @else
            <img class="user-avatar rounded-circle mr-2" src="{{asset('adminpanel/images/avatar/dummy.png')}}" alt="">

                                                    ...
                                                    <div class="avatar-preview avatar-preview-sm mx-auto">
                                                        @if ($avatar != null)
                                                            <img class="candidate_thumb rounded-50"
                                                                src="{{ asset('public/storage/' . $avatar) }}"
                                                                alt="" id="imagePreview">
                                                        @else
                                                            <img class="candidate_thumb rounded-50"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <label for="lastName" class="form-label fs-14 text-theme-primary fw-bold">Last
                                            Name*</label>
                                        {{-- <input type="text" class="form-control h-50px" name="lastName" value="" required> --}}
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="single-field full-width phone-input-flag d-flex ">
                                            {{-- <input type="text" class="form-control h-50px " maxlength="4" value="{{ $country_code }}" name="country_code" > --}}
                                            <input type="tel" class="mobile-number form-control h-50px"
                                                style="color: transparent;" name="country_code" value="{{ $country_code }}"
                                                required>
                                    ...
                                    {{-- <div class="col">
                                        ...
                                        <input type="tel" class="form-control h-50px" name="phone" value="{{ $phone }}" required>
                                    </div> --}}
                                    <div class="col-lg-3">
                                        <label for="abn"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input id="searchInput" value="{{ $address }}"
                                    ...
                                    {{-- <div class="col-md-6">
                                        ...
                                        <textarea class="form-control fs-14 h-50px textarea_register_process" name="description" required>{{ $description }}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="tagline" class="form-label fs-14 text-theme-primary fw-bold">Tag Line*</label>
                                        <textarea class="form-control fs-14 h-50px textarea_register_process" name="tagline" required>{{ $tagline }}</textarea>
                                    </div> --}}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check py-2 ">
                                            ...
                                            <label class="form-check-label text-dark fs-14" for="gridCheck">
                                                I agree to <a href="{{ route('terms') }}" target="_blank">Terms And
                                                    Condition*</a>.
                                            </label>
                                        </div>
                                    </div>

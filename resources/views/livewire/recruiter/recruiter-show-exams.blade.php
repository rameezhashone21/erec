...
<div class="col-xl-9 col-lg-8">
    ...
    <div class="dashboard_content bg-white rounded_10 p-4">
        ...
        <div class="d-md-flex aling-items-center mb-3">
            ...
            <div class="ms-auto">
                <a href="{{ route('recruiter.exam.create') }}" role="button"
        ...
        <div class="table-responsive table_height scrollbar">
            <table class="table table-striped table-payment display nowrap" style="width:100%">
                ...
                <tbody>
                    ...
                    @if (count($exams_recruiter) > 0)
                        @foreach ($exams_recruiter as $key => $row)
                            <tr>
                                ...
                                <td class="set-width-table-4">
                                    <div class="d-flex" style="gap: 4px;">
                                        <div style="width:100%; display:flex; align-items:center;">
                                            <a href="{{ route('recruiter.exam.update', ['id' => $row->id]) }}"
                                                data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"
                                                class="btn btn_viewall">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        </div>
                                        <form action="{{ route('recruiter.exam.delete', ['id' => $row->id]) }}"
                                        ...
                                        <a href="{{ route('recruiter.exam.question.listing', ['id' => $row->id]) }}"

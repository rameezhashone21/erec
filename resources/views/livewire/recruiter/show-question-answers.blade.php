  ...
  <div class="dashboard_content bg-white rounded_10 p-4">
    ...
    <div class="d-md-flex aling-items-center mb-3">
      ...
      <button id="importButton" type="button" 
        ...
        <a href="{{ route('recruiter.exam.question.create', ['id' => $exam->id]) }}" role="button"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content p-4">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('recruiter.exam.uploadCSV') }}" enctype="multipart/form-data">
                    @csrf
              ...
              <div class="d-flex ">
                ...
                <div class="dropdown me-3 align-self-center">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li class="px-3 pb-3">
                    <form action="{{ route('recruiter.exam.question.remove') }}" method="post">
                        @csrf
              ...
              <tr>
                ...
                <td class="set-width-table-4">
                  <div class="d-flex" style="gap: 4px;">
                    <a href="{{ route('recruiter.exam.question.update', ['id' => $row->id]) }}" data-bs-toggle="tooltip"
                      data-bs-placement="top" title="Edit" class="btn btn_viewall">
                      <i class="fas fa-edit"></i>
                    </a>

                    <a href="{{ route('recruiter.exam.question.delete', ['id' => $row->id]) }}" data-bs-toggle="tooltip"

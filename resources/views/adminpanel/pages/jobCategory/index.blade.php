        ...
        <div class="table-responsive shadow">
            <div class="table-header-panel">
                <div class="d-flex align-items-center justify-content-between">
                    <h3 class="title-2">Job Categories</h3>
                    <div>
                        <a class="btn btn-primary btn_panel" href="{{ route('admin.jobCategory.create') }}"> Add New Job
                            Category
                        </a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center" style="gap: 0 6px;">
                                            <a href="{{ route('admin.jobCategory.edit', $row['class_id']) }}"

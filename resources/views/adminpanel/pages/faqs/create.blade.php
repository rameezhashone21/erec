    ...
    <form method="post" action="{{ route('faqs.store') }}" enctype="multipart/form-data">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" class="form-control fs-14 h-50px" name="heading" value="" placeholder="heading"
            required>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          ...
          <textarea class="form-control fs-14 h-50px" name="subject" value="" placeholder="subject" required></textarea>
        </div>
      </div>
      <div class="form-group">

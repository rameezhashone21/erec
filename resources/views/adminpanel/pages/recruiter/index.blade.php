...
@section('content')
    ...
    <div class="mb-5 col-md-12">
                        ...
                        @if (count($rec) > 0)
                            @foreach ($rec as $key => $row)
                                <tr>
                                    ...
                                    <td>
                                        {{-- <a href="{{ route('admin.recruiterDetails', $row->slug) }}"
                                            class="btn btn-primary btn-sm mt-2"><i class="fa fa-info"
                                                style="font-size:18px"></i></a>
                                        <a href="{{ route('admin.recruiterDestroy', $row->id) }}"
                                            onclick="return confirm('Are you sure you want to delete?');"
                                            class="btn btn-danger btn-sm mt-2"><i class="fa fa-trash"
                                                style="font-size:18px"></i></a> --}}
                                        ...
                                        {{-- <a class="btn btn_viewall delete"
                                                href="{{ route('admin.recruiterDestroy', $row->id) }}"
                                                onclick="return confirm('Are you sure you want to delete?');">
        ...
        @else
            <tr>
                <td colspan="5" allign="center">No data available</td>
            </tr>
            @endif
            </tbody>
            </table>
